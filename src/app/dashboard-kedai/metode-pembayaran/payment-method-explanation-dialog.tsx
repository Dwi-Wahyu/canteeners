  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <IconExclamationCircle className="text-muted-foreground w-5 h-5 cursor-pointer hover:text-primary transition-colors" />
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="border p-3 rounded-md">
              <h6 className="font-semibold flex items-center">
                <IconCash className="w-4 h-4 mr-1" />
            ...
            <div className="border p-3 rounded-md">
              <h6 className="font-semibold flex items-center">
                <IconQrcode className="w-4 h-4 mr-1" />
                QRIS
              </h6>
              <p className="text-sm mt-1 text-muted-foreground">
